...
import { RegisterExternalUserModel } from "../Models/UsuarioExternoModel";
import { CustomInput } from "../../../shared/components/CustomInput";
import { CustomSelect } from "../../../shared/components/CustomSelect";
import { createDictionary } from "../../../shared/utils";

type Props = {
  formik: FormikProps<RegisterExternalUserModel>;
...
export const FormCreateExternalUser = (props: Props) => {
  const { formik, catalogRole } = props;

  // const [clienteDictionary, setClienteDictionary] = useState<{ [key: string]: { value: string, label: string } }>({
  //   id: { value: '', label: '' }
  // });
  ...
  return (
    <form onSubmit={() => {}}>
      ...
      <Box mb={1} mt={2}>
        <CustomSelect
          onChange={(option) =>
            formik.setFieldValue("autorizarCuenta", option?.value === "1")
          }
      ...
      <Box mt={3} mb={1}>
        <Alert severity="info" sx={{ fontSize: "12px" }}>
          <b>Aviso:</b> Puede decidir ingresar una <b>contraseña</b> o dejar que
          el sistema genere una de forma <b>aleatoria</b>.
        </Alert>
        <Box mt={1}>
          <CustomInput
